...
<!-- vue root -->
    ...
    <div class="loader-wrap" :class="{ 'visible': loaderVisible }">
      <div class="loader-content">
        <div v-if="status === 0"><i>📡</i> <br /> BlockBazaar ---> Cyprto Market Cap </div>
        <div v-else-if="status === 1"><i>💬</i> <br /> Please bear with Us a More ...</div>
