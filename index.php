...
<body>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse justify-content-end" id="main_nav">
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link" data-bs-toggle="modal" href="#loginModal" id="login"> Log In </a></li>
					...
					<div class="d-none btn-group dropstart" id="profile">
						<button type="button" class="btn-user btn-secondary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
						...
						<div class="container" id="login">
							<form action="authentication.php" method="post" name="loginform">
								...
								<div class="modal-footer justify-content-center">
									<div class="mt-3">
										<button type="submit" class="btn m-2" style="color: black; border-color: black;" value="signin" name="signin">Sign in</button>&nbsp;
										<a class="btn m-2" style="color: black; border-color: black;" href="signup.php">Register</a>
									</div>
								</div>
							</form>
						</div>
		...
		<div class="hero-full-screen">
			<div class="middle-content-section container-fluid">
				...
				<div class="container">
					<div class="row">
						<div class="col">
							<h1 class="mb-3" style="padding-bottom: 30px;">Buy or Invest in Digital Assets now with Most Secured Technology</h1>
							<a class="btn btn1 btn-outline-light m-2" style="" href="" role="button" rel="nofollow" target="_blank">Get a call</a>
							<a class="btn btn-outline-light btn-lg m-2" href="crypto.html" target="_blank" role="button">Go to Cypto-Market</a>
						</div>
						<div class="col">
							<img src="img/text-removebg-preview.png" class="col-md-6 float-md-end mb-3 ms-md-3" alt="..." style="height: 300px; object-fit: cover;">
						</div>
					</div>
				</div>
	...
	<section class="container-xl">
		...
		<div class="row content gx-0">
			<div class="col">
				<p>
					We provide Secured and Reliable Crypto-Trade and Asset Exchange at your ease
				</p>
				<ul style="padding-bottom: 20px;">
					<li><i class="ri-check-double-line"></i> A systematic approach to reach solutions</li>
					<li><i class="ri-check-double-line"></i> Current technology services with modern trends</li>
					<li><i class="ri-check-double-line"></i> Blockchain based Exchange Model</li>
				</ul>
				<div class="btn" style="color: black; border-color: black;">Read More<span class="fas fa-arrow-right"></span></div>
			</div>
			<div class="col text-center">
				<img src="img/phone.png" class="col-md-6 float-md-end mb-3 ms-md-3" alt="" style="height: 350px; width: min-content;">
			</div>
		</div>
	</section>
	<section id="services" class="services">
		<div class="section-title">
			<h2>A Trusted Crypto-Trade Platform</h2>
		</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-3 col-md-6 footer-contact mx-auto">
						<h3 style="border: 3px solid white; width: fit-content; border-radius: 50px; padding: 0 6px 0 6px;">Block Bazaar</h3>
