                        ...
                        <form action="signUpResponse.php" method="post" align="center" onsubmit="formValidate()">
                            ...
                            <div class="row gx-3 gy-2 mt-2 mb-2 justify-content-around align-items-end">
                                <div class="col-sm-5">
                                    ...
                                    <input type="tel" pattern="[0-9]{10}" class="form-control text-center" id="contact" required>
                                </div>
                                <div class="col-sm-5">
                            ...
                            <div class="row gx-3 gy-2 mt-2 mb-2 justify-content-around align-items-end">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <input type="text" pattern="[0-9]" class="form-control text-center" id="zipCode" name="zipCode">
                                </div>
                            </div>
                            <div class="row gx-3 gy-2 mt-2 mb-2 justify-content-around align-items-end">
                                <div class="col-sm-5">
