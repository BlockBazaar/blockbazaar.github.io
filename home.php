				...
				<ul class="navbar-nav">
					...
					<li class="nav-item dropdown mb-2 me-md-2" id="navli">
						...
						<ul class="dropdown-menu">
							<li><a class="dropdown-item" id="navbtn" target="_self" href="disputes.php">Disputes</a>
							</li>
							<li><a class="dropdown-item" id="navbtn" target="_self" href="orders.php">Orders</a></li>
							<li><a class="dropdown-item" id="navbtn" target="_self" href="ownedAssets.php">Owned
									Assets</a></li>
							<li><a class="dropdown-item" id="navbtn" target="_self" href="wishlist.php">Wishlist</a>
							</li>
							<li>
								<hr class="dropdown-divider">
							</li>
							<li><a class="dropdown-item" id="navbtn" target="_self" href="index.php">Logout</a></li>
						</ul>
					</li>
				</ul>
			</div>
