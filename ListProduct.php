            ...
            <div class="body">
                <div class="container-fluid">
                    <div class="container" id="listing">
                        <form action="ListingResponse.php" method="post" align="center">
                            <div class="row gx-3 gy-2 mt-2 mb-2 justify-content-around align-items-end">
                                <div class="col-sm-5">
                                    ...
                                    <input type="text" class="form-control text-center" id="pdtName" required>
                                </div>
                                <div class="col-sm-5">
                            ...
                            <div class="row gx-3 gy-2 mt-2 mb-2 justify-content-around align-items-end">
                                <div class="col-sm-5">
                                    ...
                                    <input type="text" class="form-control text-center" id="brand" required>
                                </div>
                                <div class="col-sm-5">
                                    <label class="form-label" for="colr">
                                        <font style="color: red;">*</font>Colour
                                    </label>
                                    <input type="text" class="form-control text-center" id="colr" required>
                                </div>
                            </div>
                            <div class="row gx-3 gy-2 mt-2 mb-2 justify-content-around align-items-center">
                                <div class="col-sm-auto">
                                    ...
                                    <input type="text" class="form-control text-center" id="description" required>
                                </div>
                                <div class="col-sm-5">
                                    <label class="form-label" for="price">Price</label>
                                    <input type="text" pattern="[0-9]+(\.[0-9][0-9]?)?" class="form-control text-center" id="zipCode" name="zipCode">
                                </div>
                            </div>
